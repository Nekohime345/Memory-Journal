      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-2xl mx-auto px-4 py-6 sm:py-10">
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-4 sm:p-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2 text-center">Add a New Memory</h2>
            <p className="text-sm sm:text-base text-gray-600 text-center mb-6 sm:mb-8">Upload a photo to remember this moment</p>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <label
                    ...
                    className="flex flex-col items-center justify-center w-full h-40 sm:h-48 border-2 border-dashed border-purple-300 rounded-2xl cursor-pointer bg-purple-50 hover:bg-purple-100 transition-colors"
                  >
                    <Upload className="w-10 sm:w-12 h-10 sm:h-12 text-purple-400 mb-2 sm:mb-3" />
                    <span className="text-base sm:text-lg font-medium text-purple-600">Click to upload</span>
                    <span className="text-xs sm:text-sm text-gray-500 mt-1">PNG, JPG up to 5MB</span>
                  </label>
                </div>
